...
import 'package:erp/views/dss/inquiry/inquiryinventory.dart';
...
class DSSMenuList extends StatefulWidget {
  const DSSMenuList({super.key});

  @override
  State<DSSMenuList> createState() => _DSSMenuListState();
}

IconData getIconFromName(String name) {
  const iconMap = {
    'meeting': FontAwesomeIcons.users,
    'inventory': FontAwesomeIcons.cubes
  };
  return iconMap[name] ?? Icons.help_outline;
}

final Map<String, Widget> routeMap = {
  'Meeting': const MeetingList(),
  'Inventory': const InquiryInventory(),
};
    ...
    return Padding(
      ...
      child: Material(
        ...
        child: ListTile(
          ...
          leading: Icon(icon, color: const Color.fromARGB(255, 77, 82, 177)),
...
class _DSSMenuListState extends State<DSSMenuList> {
    int selectedIndex = -1;
  int tabindex = 0;
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        backgroundColor: const Color.fromARGB(255, 77, 82, 177),
        title: Row(
          children: [
      ...
      body: Column(
        children: [
          Container(
            color: const Color.fromARGB(255, 77, 82, 177),
          ...
          const Padding(
            ...
            child: Row(
              ...
              children: [
                Icon(FontAwesomeIcons.layerGroup, size: 24),
      ...
      bottomNavigationBar: BottomNavigationBar(
        ...
        selectedItemColor: const Color.fromARGB(255, 77, 82, 177),
        ...
        items: const [
          ...
          BottomNavigationBarItem(
              icon: Icon(FontAwesomeIcons.bell), label: 'News'),
          BottomNavigationBarItem(
